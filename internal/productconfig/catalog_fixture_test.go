...
func testProfileCatalog() productconfig.ProfileCatalog {
	return productconfig.ProfileCatalog{
		...
		productconfig.ProfileBuilderStorageLANDNS:       {Capabilities: []productconfig.Capability{productconfig.CapabilityBase, productconfig.CapabilityHost, productconfig.CapabilityFiles, productconfig.CapabilityWorkflows, productconfig.CapabilityBuild, productconfig.CapabilityArtifact, productconfig.CapabilityDNS}},
		...
		productconfig.ProfileTraining:                   {Capabilities: []productconfig.Capability{productconfig.CapabilityBase, productconfig.CapabilityHost, productconfig.CapabilityFiles, productconfig.CapabilityVideo, productconfig.CapabilityApplications, productconfig.CapabilityPlaintextHTTP}},
	}
}
